...
export default function LeverChart({ E, quote, consumptionFactor = 1, height = 220, model = 'ggv' }) {
  const atQuote = useMemo(() => irrCurve(E, quote, 55, 105, 2.5, consumptionFactor, model), [E, quote, consumptionFactor, model]);
  const atFull = useMemo(() => irrCurve(E, 100, 55, 105, 2.5, consumptionFactor, model), [E, consumptionFactor, model]);
